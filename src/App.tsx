...
export default function App() {
  ...
  const yearKey = `${ym.y}-`;
  const yearPaidLeave = Object.entries(records).filter(
  ...
  return (
    <div style={styles.page}>
      ...
      <div style={styles.summary}>
        <div>残業合計：{Math.floor(totalOver / 60)}時間 {totalOver % 60}分</div>
...
const styles: any = {
  page: { background: "#FFF7EE", minHeight: "100vh", padding: 10 },
  ...
  summary: { marginTop: 10, fontSize: 18, fontWeight: 600, lineHeight: 1.6 },
  ...
  save: { width: "100%", padding: 12, borderRadius: 12, fontSize: 16 }
};
